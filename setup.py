...
setup(# package information
      name=PACKAGENAME,
      version=__version__,
      description='simple repository for filtering alerts for relevant counterparts',
      long_description=''' ''',
      # What code to include as packages
      packages=[PACKAGENAME],
      packagedir={PACKAGENAME: 'emgw_filters'},
      # What data to include as packages
      include_package_data=True,
      package_data={PACKAGENAME:['example_data/*.csv', 'example_data/*.gz',
                                ]}
      )
